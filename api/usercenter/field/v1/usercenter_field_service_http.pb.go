...
const OperationFieldCreateField = "/usercenter.api.usercenter.field.v1.Field/CreateField"
const OperationFieldDeleteField = "/usercenter.api.usercenter.field.v1.Field/DeleteField"
const OperationFieldListField = "/usercenter.api.usercenter.field.v1.Field/ListField"
const OperationFieldListFieldType = "/usercenter.api.usercenter.field.v1.Field/ListFieldType"
const OperationFieldUpdateField = "/usercenter.api.usercenter.field.v1.Field/UpdateField"
const OperationFieldUpdateFieldStatus = "/usercenter.api.usercenter.field.v1.Field/UpdateFieldStatus"
...
type FieldHTTPServer interface {
	...
	// UpdateFieldStatus UpdateFieldStatus 更新用户字段状态
	UpdateFieldStatus(context.Context, *UpdateFieldStatusRequest) (*UpdateFieldStatusReply, error)
}

func RegisterFieldHTTPServer(s *http.Server, srv FieldHTTPServer) {
	r := s.Route("/")
	r.GET("/usercenter/api/v1/field/types", _Field_ListFieldType0_HTTP_Handler(srv))
	r.GET("/usercenter/api/v1/fields", _Field_ListField0_HTTP_Handler(srv))
	r.POST("/usercenter/api/v1/field", _Field_CreateField0_HTTP_Handler(srv))
	r.PUT("/usercenter/api/v1/field", _Field_UpdateField0_HTTP_Handler(srv))
	r.PUT("/usercenter/api/v1/field/status", _Field_UpdateFieldStatus0_HTTP_Handler(srv))
	r.DELETE("/usercenter/api/v1/field", _Field_DeleteField0_HTTP_Handler(srv))
}
...
func _Field_UpdateFieldStatus0_HTTP_Handler(srv FieldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in UpdateFieldStatusRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationFieldUpdateFieldStatus)
		h := ctx.Middleware(func(ctx context.Context, req any) (any, error) {
			return srv.UpdateFieldStatus(ctx, req.(*UpdateFieldStatusRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*UpdateFieldStatusReply)
		return ctx.Result(200, reply)
	}
}
...
type FieldHTTPClient interface {
	...
	UpdateFieldStatus(ctx context.Context, req *UpdateFieldStatusRequest, opts ...http.CallOption) (rsp *UpdateFieldStatusReply, err error)
}
...
func (c *FieldHTTPClientImpl) CreateField(ctx context.Context, in *CreateFieldRequest, opts ...http.CallOption) (*CreateFieldReply, error) {
	...
	pattern := "/usercenter/api/v1/field"
...
func (c *FieldHTTPClientImpl) ListField(ctx context.Context, in *ListFieldRequest, opts ...http.CallOption) (*ListFieldReply, error) {
	...
	pattern := "/usercenter/api/v1/fields"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *FieldHTTPClientImpl) ListFieldType(ctx context.Context, in *ListFieldTypeRequest, opts ...http.CallOption) (*ListFieldTypeReply, error) {
	...
	pattern := "/usercenter/api/v1/field/types"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *FieldHTTPClientImpl) UpdateFieldStatus(ctx context.Context, in *UpdateFieldStatusRequest, opts ...http.CallOption) (*UpdateFieldStatusReply, error) {
	var out UpdateFieldStatusReply
	pattern := "/usercenter/api/v1/field/status"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationFieldUpdateFieldStatus))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "PUT", path, in, &out, opts...)
	if err != nil {
		return nil, err
