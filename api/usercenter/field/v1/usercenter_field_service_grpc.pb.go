...
const (
	Field_ListFieldType_FullMethodName     = "/usercenter.api.usercenter.field.v1.Field/ListFieldType"
	Field_ListField_FullMethodName         = "/usercenter.api.usercenter.field.v1.Field/ListField"
	Field_CreateField_FullMethodName       = "/usercenter.api.usercenter.field.v1.Field/CreateField"
	Field_UpdateField_FullMethodName       = "/usercenter.api.usercenter.field.v1.Field/UpdateField"
	Field_UpdateFieldStatus_FullMethodName = "/usercenter.api.usercenter.field.v1.Field/UpdateFieldStatus"
	Field_DeleteField_FullMethodName       = "/usercenter.api.usercenter.field.v1.Field/DeleteField"
)
...
type FieldClient interface {
	...
	UpdateFieldStatus(ctx context.Context, in *UpdateFieldStatusRequest, opts ...grpc.CallOption) (*UpdateFieldStatusReply, error)
	// DeleteField 删除用户字段
...
func (c *fieldClient) UpdateFieldStatus(ctx context.Context, in *UpdateFieldStatusRequest, opts ...grpc.CallOption) (*UpdateFieldStatusReply, error) {
	out := new(UpdateFieldStatusReply)
	err := c.cc.Invoke(ctx, Field_UpdateFieldStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFieldServer) UpdateFieldStatus(context.Context, *UpdateFieldStatusRequest) (*UpdateFieldStatusReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateFieldStatus not implemented")
}
...
func _Field_UpdateFieldStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateFieldStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FieldServer).UpdateFieldStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Field_UpdateFieldStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FieldServer).UpdateFieldStatus(ctx, req.(*UpdateFieldStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Field_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "usercenter.api.usercenter.field.v1.Field",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateFieldStatus",
			Handler:    _Field_UpdateFieldStatus_Handler,
		},
		{
	...
	Metadata: "api/usercenter/field/usercenter_field_service.proto",
}
