...
// Validate checks the field values on UpdateFieldStatusRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateFieldStatusRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateFieldStatusRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateFieldStatusRequestMultiError, or nil if none found.
func (m *UpdateFieldStatusRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateFieldStatusRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetId() <= 0 {
		err := UpdateFieldStatusRequestValidationError{
			field:  "Id",
			reason: "value must be greater than 0",
		}
		if !all {
	...
	if len(errors) > 0 {
		return UpdateFieldStatusRequestMultiError(errors)
	}

	return nil
}

// UpdateFieldStatusRequestMultiError is an error wrapping multiple validation
// errors returned by UpdateFieldStatusRequest.ValidateAll() if the designated
// constraints aren't met.
type UpdateFieldStatusRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateFieldStatusRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateFieldStatusRequestMultiError) AllErrors() []error { return m }

// UpdateFieldStatusRequestValidationError is the validation error returned by
// UpdateFieldStatusRequest.Validate if the designated constraints aren't met.
type UpdateFieldStatusRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateFieldStatusRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateFieldStatusRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateFieldStatusRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateFieldStatusRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateFieldStatusRequestValidationError) ErrorName() string {
	return "UpdateFieldStatusRequestValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateFieldStatusRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateFieldStatusRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateFieldStatusRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateFieldStatusRequestValidationError{}

// Validate checks the field values on UpdateFieldStatusReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateFieldStatusReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateFieldStatusReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateFieldStatusReplyMultiError, or nil if none found.
func (m *UpdateFieldStatusReply) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateFieldStatusReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UpdateFieldStatusReplyMultiError(errors)
	}

	return nil
}

// UpdateFieldStatusReplyMultiError is an error wrapping multiple validation
// errors returned by UpdateFieldStatusReply.ValidateAll() if the designated
// constraints aren't met.
type UpdateFieldStatusReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateFieldStatusReplyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateFieldStatusReplyMultiError) AllErrors() []error { return m }

// UpdateFieldStatusReplyValidationError is the validation error returned by
// UpdateFieldStatusReply.Validate if the designated constraints aren't met.
type UpdateFieldStatusReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateFieldStatusReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateFieldStatusReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateFieldStatusReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateFieldStatusReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateFieldStatusReplyValidationError) ErrorName() string {
	return "UpdateFieldStatusReplyValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateFieldStatusReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateFieldStatusReply.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateFieldStatusReplyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateFieldStatusReplyValidationError{}
...
func (m *DeleteFieldRequest) validate(all bool) error {
	...
	_DeleteFieldRequest_Ids_Unique := make(map[uint32]struct{}, len(m.GetIds()))

	for idx, item := range m.GetIds() {
		_, _ = idx, item

		if _, exists := _DeleteFieldRequest_Ids_Unique[item]; exists {
			err := DeleteFieldRequestValidationError{
			...
			_DeleteFieldRequest_Ids_Unique[item] = struct{}{}
		}
