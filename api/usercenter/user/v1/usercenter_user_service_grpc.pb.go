...
const (
	User_GetCurrentUser_FullMethodName    = "/usercenter.api.usercenter.user.v1.User/GetCurrentUser"
	User_UpdateCurrentUser_FullMethodName = "/usercenter.api.usercenter.user.v1.User/UpdateCurrentUser"
	User_GetUser_FullMethodName           = "/usercenter.api.usercenter.user.v1.User/GetUser"
	User_ListUser_FullMethodName          = "/usercenter.api.usercenter.user.v1.User/ListUser"
	User_CreateUser_FullMethodName        = "/usercenter.api.usercenter.user.v1.User/CreateUser"
	User_ImportUser_FullMethodName        = "/usercenter.api.usercenter.user.v1.User/ImportUser"
	User_ExportUser_FullMethodName        = "/usercenter.api.usercenter.user.v1.User/ExportUser"
	User_UpdateUser_FullMethodName        = "/usercenter.api.usercenter.user.v1.User/UpdateUser"
	User_UpdateUserStatus_FullMethodName  = "/usercenter.api.usercenter.user.v1.User/UpdateUserStatus"
	User_DeleteUser_FullMethodName        = "/usercenter.api.usercenter.user.v1.User/DeleteUser"
	User_GetTrashUser_FullMethodName      = "/usercenter.api.usercenter.user.v1.User/GetTrashUser"
	User_ListTrashUser_FullMethodName     = "/usercenter.api.usercenter.user.v1.User/ListTrashUser"
	User_DeleteTrashUser_FullMethodName   = "/usercenter.api.usercenter.user.v1.User/DeleteTrashUser"
	User_RevertTrashUser_FullMethodName   = "/usercenter.api.usercenter.user.v1.User/RevertTrashUser"
)
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "usercenter.api.usercenter.user.v1.User",
	...
	Metadata: "api/usercenter/user/usercenter_user_service.proto",
}
