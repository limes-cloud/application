...
const OperationChannelCreateChannel = "/usercenter.api.usercenter.channel.v1.Channel/CreateChannel"
const OperationChannelDeleteChannel = "/usercenter.api.usercenter.channel.v1.Channel/DeleteChannel"
const OperationChannelListChannel = "/usercenter.api.usercenter.channel.v1.Channel/ListChannel"
const OperationChannelListChannelType = "/usercenter.api.usercenter.channel.v1.Channel/ListChannelType"
const OperationChannelUpdateChannel = "/usercenter.api.usercenter.channel.v1.Channel/UpdateChannel"
const OperationChannelUpdateChannelStatus = "/usercenter.api.usercenter.channel.v1.Channel/UpdateChannelStatus"
...
type ChannelHTTPServer interface {
	...
	// UpdateChannelStatus UpdateChannelStatus 更新登陆渠道状态
	UpdateChannelStatus(context.Context, *UpdateChannelStatusRequest) (*UpdateChannelStatusReply, error)
}

func RegisterChannelHTTPServer(s *http.Server, srv ChannelHTTPServer) {
	r := s.Route("/")
	r.GET("/usercenter/api/v1/channel/types", _Channel_ListChannelType0_HTTP_Handler(srv))
	r.GET("/usercenter/api/v1/channels", _Channel_ListChannel0_HTTP_Handler(srv))
	r.POST("/usercenter/api/v1/channel", _Channel_CreateChannel0_HTTP_Handler(srv))
	r.PUT("/usercenter/api/v1/channel", _Channel_UpdateChannel0_HTTP_Handler(srv))
	r.PUT("/usercenter/api/v1/channel/status", _Channel_UpdateChannelStatus0_HTTP_Handler(srv))
	r.DELETE("/usercenter/api/v1/channel", _Channel_DeleteChannel0_HTTP_Handler(srv))
}
...
func _Channel_UpdateChannelStatus0_HTTP_Handler(srv ChannelHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in UpdateChannelStatusRequest
		if err := ctx.Bind(&in); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationChannelUpdateChannelStatus)
		h := ctx.Middleware(func(ctx context.Context, req any) (any, error) {
			return srv.UpdateChannelStatus(ctx, req.(*UpdateChannelStatusRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*UpdateChannelStatusReply)
		return ctx.Result(200, reply)
	}
}
...
type ChannelHTTPClient interface {
	...
	UpdateChannelStatus(ctx context.Context, req *UpdateChannelStatusRequest, opts ...http.CallOption) (rsp *UpdateChannelStatusReply, err error)
}
...
func (c *ChannelHTTPClientImpl) CreateChannel(ctx context.Context, in *CreateChannelRequest, opts ...http.CallOption) (*CreateChannelReply, error) {
	...
	pattern := "/usercenter/api/v1/channel"
...
func (c *ChannelHTTPClientImpl) ListChannel(ctx context.Context, in *ListChannelRequest, opts ...http.CallOption) (*ListChannelReply, error) {
	...
	pattern := "/usercenter/api/v1/channels"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *ChannelHTTPClientImpl) ListChannelType(ctx context.Context, in *ListChannelTypeRequest, opts ...http.CallOption) (*ListChannelTypeReply, error) {
	...
	pattern := "/usercenter/api/v1/channel/types"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *ChannelHTTPClientImpl) UpdateChannelStatus(ctx context.Context, in *UpdateChannelStatusRequest, opts ...http.CallOption) (*UpdateChannelStatusReply, error) {
	var out UpdateChannelStatusReply
	pattern := "/usercenter/api/v1/channel/status"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationChannelUpdateChannelStatus))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "PUT", path, in, &out, opts...)
	if err != nil {
		return nil, err
