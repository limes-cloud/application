...
// Validate checks the field values on UpdateChannelStatusRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateChannelStatusRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateChannelStatusRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateChannelStatusRequestMultiError, or nil if none found.
func (m *UpdateChannelStatusRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateChannelStatusRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetId() <= 0 {
		err := UpdateChannelStatusRequestValidationError{
			field:  "Id",
			reason: "value must be greater than 0",
		}
		if !all {
	...
	if len(errors) > 0 {
		return UpdateChannelStatusRequestMultiError(errors)
	}

	return nil
}

// UpdateChannelStatusRequestMultiError is an error wrapping multiple
// validation errors returned by UpdateChannelStatusRequest.ValidateAll() if
// the designated constraints aren't met.
type UpdateChannelStatusRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateChannelStatusRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateChannelStatusRequestMultiError) AllErrors() []error { return m }

// UpdateChannelStatusRequestValidationError is the validation error returned
// by UpdateChannelStatusRequest.Validate if the designated constraints aren't met.
type UpdateChannelStatusRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateChannelStatusRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateChannelStatusRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateChannelStatusRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateChannelStatusRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateChannelStatusRequestValidationError) ErrorName() string {
	return "UpdateChannelStatusRequestValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateChannelStatusRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateChannelStatusRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateChannelStatusRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateChannelStatusRequestValidationError{}

// Validate checks the field values on UpdateChannelStatusReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateChannelStatusReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateChannelStatusReply with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateChannelStatusReplyMultiError, or nil if none found.
func (m *UpdateChannelStatusReply) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateChannelStatusReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UpdateChannelStatusReplyMultiError(errors)
	}

	return nil
}

// UpdateChannelStatusReplyMultiError is an error wrapping multiple validation
// errors returned by UpdateChannelStatusReply.ValidateAll() if the designated
// constraints aren't met.
type UpdateChannelStatusReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateChannelStatusReplyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateChannelStatusReplyMultiError) AllErrors() []error { return m }

// UpdateChannelStatusReplyValidationError is the validation error returned by
// UpdateChannelStatusReply.Validate if the designated constraints aren't met.
type UpdateChannelStatusReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateChannelStatusReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateChannelStatusReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateChannelStatusReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateChannelStatusReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateChannelStatusReplyValidationError) ErrorName() string {
	return "UpdateChannelStatusReplyValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateChannelStatusReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateChannelStatusReply.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateChannelStatusReplyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateChannelStatusReplyValidationError{}
...
func (m *DeleteChannelRequest) validate(all bool) error {
	...
	_DeleteChannelRequest_Ids_Unique := make(map[uint32]struct{}, len(m.GetIds()))

	for idx, item := range m.GetIds() {
		_, _ = idx, item

		if _, exists := _DeleteChannelRequest_Ids_Unique[item]; exists {
			err := DeleteChannelRequestValidationError{
			...
			_DeleteChannelRequest_Ids_Unique[item] = struct{}{}
		}
