...
const (
	Channel_ListChannelType_FullMethodName     = "/usercenter.api.usercenter.channel.v1.Channel/ListChannelType"
	Channel_ListChannel_FullMethodName         = "/usercenter.api.usercenter.channel.v1.Channel/ListChannel"
	Channel_CreateChannel_FullMethodName       = "/usercenter.api.usercenter.channel.v1.Channel/CreateChannel"
	Channel_UpdateChannel_FullMethodName       = "/usercenter.api.usercenter.channel.v1.Channel/UpdateChannel"
	Channel_UpdateChannelStatus_FullMethodName = "/usercenter.api.usercenter.channel.v1.Channel/UpdateChannelStatus"
	Channel_DeleteChannel_FullMethodName       = "/usercenter.api.usercenter.channel.v1.Channel/DeleteChannel"
)
...
type ChannelClient interface {
	...
	UpdateChannelStatus(ctx context.Context, in *UpdateChannelStatusRequest, opts ...grpc.CallOption) (*UpdateChannelStatusReply, error)
...
func (c *channelClient) UpdateChannelStatus(ctx context.Context, in *UpdateChannelStatusRequest, opts ...grpc.CallOption) (*UpdateChannelStatusReply, error) {
	out := new(UpdateChannelStatusReply)
	err := c.cc.Invoke(ctx, Channel_UpdateChannelStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedChannelServer) UpdateChannelStatus(context.Context, *UpdateChannelStatusRequest) (*UpdateChannelStatusReply, error) {
...
func _Channel_UpdateChannelStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateChannelStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChannelServer).UpdateChannelStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Channel_UpdateChannelStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChannelServer).UpdateChannelStatus(ctx, req.(*UpdateChannelStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Channel_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "usercenter.api.usercenter.channel.v1.Channel",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Channel_UpdateChannelStatus_Handler,
		},
		{
	...
	Metadata: "api/usercenter/channel/usercenter_channel_service.proto",
}
