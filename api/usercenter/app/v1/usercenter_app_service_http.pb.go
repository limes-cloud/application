...
const OperationAppCreateApp = "/usercenter.api.usercenter.app.v1.App/CreateApp"
const OperationAppDeleteApp = "/usercenter.api.usercenter.app.v1.App/DeleteApp"
const OperationAppGetApp = "/usercenter.api.usercenter.app.v1.App/GetApp"
const OperationAppListApp = "/usercenter.api.usercenter.app.v1.App/ListApp"
const OperationAppUpdateApp = "/usercenter.api.usercenter.app.v1.App/UpdateApp"
const OperationAppUpdateAppStatus = "/usercenter.api.usercenter.app.v1.App/UpdateAppStatus"
...
func RegisterAppHTTPServer(s *http.Server, srv AppHTTPServer) {
	r := s.Route("/")
	r.GET("/usercenter/client/v1/app", _App_GetApp0_HTTP_Handler(srv))
	r.GET("/usercenter/api/v1/app", _App_GetApp1_HTTP_Handler(srv))
	r.GET("/usercenter/api/v1/apps", _App_ListApp0_HTTP_Handler(srv))
	r.POST("/usercenter/api/v1/app", _App_CreateApp0_HTTP_Handler(srv))
	r.PUT("/usercenter/api/v1/app", _App_UpdateApp0_HTTP_Handler(srv))
	r.PUT("/usercenter/api/v1/app/status", _App_UpdateAppStatus0_HTTP_Handler(srv))
	r.DELETE("/usercenter/api/v1/app", _App_DeleteApp0_HTTP_Handler(srv))
}
...
func (c *AppHTTPClientImpl) ListApp(ctx context.Context, in *ListAppRequest, opts ...http.CallOption) (*ListAppReply, error) {
	...
	pattern := "/usercenter/api/v1/apps"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *AppHTTPClientImpl) UpdateAppStatus(ctx context.Context, in *UpdateAppStatusRequest, opts ...http.CallOption) (*UpdateAppStatusReply, error) {
	...
	pattern := "/usercenter/api/v1/app/status"
	path := binding.EncodeURL(pattern, in, false)
