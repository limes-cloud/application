...
// Validate checks the field values on App_Channel with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on App_Channel with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in App_ChannelMultiError, or
// nil if none found.
func (m *App_Channel) ValidateAll() error {
	return m.validate(true)
}

func (m *App_Channel) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return App_ChannelMultiError(errors)
	}

	return nil
}

// App_ChannelMultiError is an error wrapping multiple validation errors
// returned by App_Channel.ValidateAll() if the designated constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m App_ChannelMultiError) AllErrors() []error { return m }

// App_ChannelValidationError is the validation error returned by
// App_Channel.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e App_ChannelValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e App_ChannelValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e App_ChannelValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e App_ChannelValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e App_ChannelValidationError) ErrorName() string { return "App_ChannelValidationError" }
...
var _ error = App_ChannelValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = App_ChannelValidationError{}

// Validate checks the field values on App_Field with the rules defined in the
...
// ValidateAll checks the field values on App_Field with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in App_FieldMultiError, or nil
// if none found.
func (m *App_Field) ValidateAll() error {
	return m.validate(true)
}

func (m *App_Field) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return App_FieldMultiError(errors)
	}

	return nil
}

// App_FieldMultiError is an error wrapping multiple validation errors returned
// by App_Field.ValidateAll() if the designated constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m App_FieldMultiError) AllErrors() []error { return m }

// App_FieldValidationError is the validation error returned by
// App_Field.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e App_FieldValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e App_FieldValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e App_FieldValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e App_FieldValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e App_FieldValidationError) ErrorName() string { return "App_FieldValidationError" }
...
var _ error = App_FieldValidationError{}
