...
const (
	Auth_RefreshToken_FullMethodName     = "/application.api.application.auth.v1.Auth/RefreshToken"
	Auth_Logout_FullMethodName           = "/application.api.application.auth.v1.Auth/Logout"
	Auth_Auth_FullMethodName             = "/application.api.application.auth.v1.Auth/Auth"
	Auth_ListAuth_FullMethodName         = "/application.api.application.auth.v1.Auth/ListAuth"
	Auth_CreateAuth_FullMethodName       = "/application.api.application.auth.v1.Auth/CreateAuth"
	Auth_UpdateAuthStatus_FullMethodName = "/application.api.application.auth.v1.Auth/UpdateAuthStatus"
	Auth_DeleteAuth_FullMethodName       = "/application.api.application.auth.v1.Auth/DeleteAuth"
	Auth_ListOAuth_FullMethodName        = "/application.api.application.auth.v1.Auth/ListOAuth"
	Auth_DeleteOAuth_FullMethodName      = "/application.api.application.auth.v1.Auth/DeleteOAuth"
	Auth_GenAuthCaptcha_FullMethodName   = "/application.api.application.auth.v1.Auth/GenAuthCaptcha"
	Auth_OAuthLogin_FullMethodName       = "/application.api.application.auth.v1.Auth/OAuthLogin"
	Auth_EmailLogin_FullMethodName       = "/application.api.application.auth.v1.Auth/EmailLogin"
	Auth_PasswordLogin_FullMethodName    = "/application.api.application.auth.v1.Auth/PasswordLogin"
	Auth_EmailRegister_FullMethodName    = "/application.api.application.auth.v1.Auth/EmailRegister"
	Auth_PasswordRegister_FullMethodName = "/application.api.application.auth.v1.Auth/PasswordRegister"
	Auth_EmailBind_FullMethodName        = "/application.api.application.auth.v1.Auth/EmailBind"
	Auth_PasswordBind_FullMethodName     = "/application.api.application.auth.v1.Auth/PasswordBind"
)
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "application.api.application.auth.v1.Auth",
	...
	Metadata: "api/application/auth/application_auth_service.proto",
}
