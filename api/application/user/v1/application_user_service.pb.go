...
var file_api_application_user_application_user_service_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xef, 0x0b, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0xab,
	...
	0x2f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x38, 0x0a, 0x23, 0x61, 0x70, 0x70, 0x6c, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x70, 0x70, 0x6c, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x42, 0x06,
	0x55, 0x73, 0x65, 0x72, 0x56, 0x31, 0x50, 0x01, 0x5a, 0x07, 0x2e, 0x2f, 0x76, 0x31, 0x3b, 0x76,
...
var file_api_application_user_application_user_service_proto_goTypes = []interface{}{
	...
	(*GetCurrentUserReply)(nil),      // 9: application.api.application.user.v1.GetCurrentUserReply
	(*UpdateCurrentUserReply)(nil),   // 10: application.api.application.user.v1.UpdateCurrentUserReply
	(*GetUserReply)(nil),             // 11: application.api.application.user.v1.GetUserReply
	(*ListUserReply)(nil),            // 12: application.api.application.user.v1.ListUserReply
	(*CreateUserReply)(nil),          // 13: application.api.application.user.v1.CreateUserReply
	(*ImportUserReply)(nil),          // 14: application.api.application.user.v1.ImportUserReply
	(*ExportUserReply)(nil),          // 15: application.api.application.user.v1.ExportUserReply
	(*UpdateUserReply)(nil),          // 16: application.api.application.user.v1.UpdateUserReply
...
var file_api_application_user_application_user_service_proto_depIdxs = []int32{
	...
	9,  // 9: application.api.application.user.v1.User.GetCurrentUser:output_type -> application.api.application.user.v1.GetCurrentUserReply
	10, // 10: application.api.application.user.v1.User.UpdateCurrentUser:output_type -> application.api.application.user.v1.UpdateCurrentUserReply
	11, // 11: application.api.application.user.v1.User.GetUser:output_type -> application.api.application.user.v1.GetUserReply
	12, // 12: application.api.application.user.v1.User.ListUser:output_type -> application.api.application.user.v1.ListUserReply
	13, // 13: application.api.application.user.v1.User.CreateUser:output_type -> application.api.application.user.v1.CreateUserReply
	14, // 14: application.api.application.user.v1.User.ImportUser:output_type -> application.api.application.user.v1.ImportUserReply
	15, // 15: application.api.application.user.v1.User.ExportUser:output_type -> application.api.application.user.v1.ExportUserReply
	16, // 16: application.api.application.user.v1.User.UpdateUser:output_type -> application.api.application.user.v1.UpdateUserReply
	17, // 17: application.api.application.user.v1.User.UpdateUserStatus:output_type -> application.api.application.user.v1.UpdateUserStatusReply
