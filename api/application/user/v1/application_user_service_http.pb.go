...
const OperationUserDeleteTrashUser = "/application.api.application.user.v1.User/DeleteTrashUser"
const OperationUserDeleteUser = "/application.api.application.user.v1.User/DeleteUser"
...
const OperationUserGetTrashUser = "/application.api.application.user.v1.User/GetTrashUser"
...
const OperationUserListTrashUser = "/application.api.application.user.v1.User/ListTrashUser"
const OperationUserListUser = "/application.api.application.user.v1.User/ListUser"
const OperationUserRevertTrashUser = "/application.api.application.user.v1.User/RevertTrashUser"
...
func RegisterUserHTTPServer(s *http.Server, srv UserHTTPServer) {
	...
	r.DELETE("/application/api/v1/user", _User_DeleteUser0_HTTP_Handler(srv))
	r.GET("/application/api/v1/user/trash", _User_GetTrashUser0_HTTP_Handler(srv))
	r.GET("/application/api/v1/user/trashes", _User_ListTrashUser0_HTTP_Handler(srv))
	r.DELETE("/application/api/v1/user/trash", _User_DeleteTrashUser0_HTTP_Handler(srv))
	r.PUT("/application/api/v1/user/trash", _User_RevertTrashUser0_HTTP_Handler(srv))
}
...
func (c *UserHTTPClientImpl) DeleteTrashUser(ctx context.Context, in *DeleteTrashUserRequest, opts ...http.CallOption) (*DeleteTrashUserReply, error) {
	...
	pattern := "/application/api/v1/user/trash"
...
func (c *UserHTTPClientImpl) ListTrashUser(ctx context.Context, in *ListTrashUserRequest, opts ...http.CallOption) (*ListTrashUserReply, error) {
	...
	pattern := "/application/api/v1/user/trashes"
	path := binding.EncodeURL(pattern, in, true)
